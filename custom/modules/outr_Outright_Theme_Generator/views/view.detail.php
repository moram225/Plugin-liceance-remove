 ...
 ********************************************************************************/
 ...
 class outr_Outright_Theme_GeneratorViewDetail extends ViewDetail
 {
	...
	**/
	...
	function display()
	{
	  ...
	  var elemval = $("span#global_body_font_fmly").html();
	  var font_name = '<?php echo html_entity_decode($this->bean->global_body_font_fmly); ?>';
	     if(!elemval && font_name){
			 $("div[field='global_body_font_fmly']").append(font_name);
		 }
	  });
